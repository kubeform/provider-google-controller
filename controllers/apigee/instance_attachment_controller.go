...
// +kubebuilder:rbac:groups=apigee.google.kubeform.com,resources=instanceattachments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apigee.google.kubeform.com,resources=instanceattachments/status,verbs=get;update;patch
...
func (r *InstanceAttachmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &apigeev1alpha1.InstanceAttachment{}); err != nil {
			klog.Error(err, "unable to set up auditor", apigeev1alpha1.InstanceAttachment{}.APIVersion, apigeev1alpha1.InstanceAttachment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&apigeev1alpha1.InstanceAttachment{}).
