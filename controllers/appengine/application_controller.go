...
// +kubebuilder:rbac:groups=appengine.google.kubeform.com,resources=applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appengine.google.kubeform.com,resources=applications/status,verbs=get;update;patch
...
func (r *ApplicationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &appenginev1alpha1.Application{}); err != nil {
			klog.Error(err, "unable to set up auditor", appenginev1alpha1.Application{}.APIVersion, appenginev1alpha1.Application{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&appenginev1alpha1.Application{}).
...
func (r *ApplicationReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &appenginev1alpha1.ApplicationList{}
