...
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasets/status,verbs=get;update;patch
...
func (r *DatasetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigqueryv1alpha1.Dataset{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigqueryv1alpha1.Dataset{}.APIVersion, bigqueryv1alpha1.Dataset{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigqueryv1alpha1.Dataset{}).
