...
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasetiambindings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasetiambindings/status,verbs=get;update;patch
...
func (r *DatasetIamBindingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigqueryv1alpha1.DatasetIamBinding{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigqueryv1alpha1.DatasetIamBinding{}.APIVersion, bigqueryv1alpha1.DatasetIamBinding{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigqueryv1alpha1.DatasetIamBinding{}).
