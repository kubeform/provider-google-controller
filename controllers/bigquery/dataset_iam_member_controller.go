...
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasetiammembers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasetiammembers/status,verbs=get;update;patch
...
func (r *DatasetIamMemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigqueryv1alpha1.DatasetIamMember{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigqueryv1alpha1.DatasetIamMember{}.APIVersion, bigqueryv1alpha1.DatasetIamMember{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigqueryv1alpha1.DatasetIamMember{}).
