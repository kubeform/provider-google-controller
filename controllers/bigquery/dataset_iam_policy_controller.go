...
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasetiampolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=datasetiampolicies/status,verbs=get;update;patch
...
func (r *DatasetIamPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigqueryv1alpha1.DatasetIamPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigqueryv1alpha1.DatasetIamPolicy{}.APIVersion, bigqueryv1alpha1.DatasetIamPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigqueryv1alpha1.DatasetIamPolicy{}).
