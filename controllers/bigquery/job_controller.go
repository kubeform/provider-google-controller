...
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=jobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=jobs/status,verbs=get;update;patch
...
func (r *JobReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigqueryv1alpha1.Job{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigqueryv1alpha1.Job{}.APIVersion, bigqueryv1alpha1.Job{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigqueryv1alpha1.Job{}).
