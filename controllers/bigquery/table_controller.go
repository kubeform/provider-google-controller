...
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=tables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigquery.google.kubeform.com,resources=tables/status,verbs=get;update;patch
...
func (r *TableReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigqueryv1alpha1.Table{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigqueryv1alpha1.Table{}.APIVersion, bigqueryv1alpha1.Table{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigqueryv1alpha1.Table{}).
