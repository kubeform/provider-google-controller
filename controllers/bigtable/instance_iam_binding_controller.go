...
// +kubebuilder:rbac:groups=bigtable.google.kubeform.com,resources=instanceiambindings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigtable.google.kubeform.com,resources=instanceiambindings/status,verbs=get;update;patch
...
func (r *InstanceIamBindingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigtablev1alpha1.InstanceIamBinding{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigtablev1alpha1.InstanceIamBinding{}.APIVersion, bigtablev1alpha1.InstanceIamBinding{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigtablev1alpha1.InstanceIamBinding{}).
