...
// +kubebuilder:rbac:groups=bigtable.google.kubeform.com,resources=tables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigtable.google.kubeform.com,resources=tables/status,verbs=get;update;patch
...
func (r *TableReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigtablev1alpha1.Table{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigtablev1alpha1.Table{}.APIVersion, bigtablev1alpha1.Table{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigtablev1alpha1.Table{}).
