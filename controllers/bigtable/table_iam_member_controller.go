...
// +kubebuilder:rbac:groups=bigtable.google.kubeform.com,resources=tableiammembers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bigtable.google.kubeform.com,resources=tableiammembers/status,verbs=get;update;patch
...
func (r *TableIamMemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &bigtablev1alpha1.TableIamMember{}); err != nil {
			klog.Error(err, "unable to set up auditor", bigtablev1alpha1.TableIamMember{}.APIVersion, bigtablev1alpha1.TableIamMember{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&bigtablev1alpha1.TableIamMember{}).
