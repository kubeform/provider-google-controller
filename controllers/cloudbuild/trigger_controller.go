...
// +kubebuilder:rbac:groups=cloudbuild.google.kubeform.com,resources=triggers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudbuild.google.kubeform.com,resources=triggers/status,verbs=get;update;patch
...
func (r *TriggerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudbuildv1alpha1.Trigger{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudbuildv1alpha1.Trigger{}.APIVersion, cloudbuildv1alpha1.Trigger{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudbuildv1alpha1.Trigger{}).
