...
// +kubebuilder:rbac:groups=cloudbuild.google.kubeform.com,resources=workerpools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudbuild.google.kubeform.com,resources=workerpools/status,verbs=get;update;patch
...
func (r *WorkerPoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudbuildv1alpha1.WorkerPool{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudbuildv1alpha1.WorkerPool{}.APIVersion, cloudbuildv1alpha1.WorkerPool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudbuildv1alpha1.WorkerPool{}).
