...
// +kubebuilder:rbac:groups=cloudiot.google.kubeform.com,resources=devices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudiot.google.kubeform.com,resources=devices/status,verbs=get;update;patch
...
func (r *DeviceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudiotv1alpha1.Device{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudiotv1alpha1.Device{}.APIVersion, cloudiotv1alpha1.Device{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudiotv1alpha1.Device{}).
