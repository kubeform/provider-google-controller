...
// +kubebuilder:rbac:groups=cloudiot.google.kubeform.com,resources=registries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudiot.google.kubeform.com,resources=registries/status,verbs=get;update;patch
...
func (r *RegistryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudiotv1alpha1.Registry{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudiotv1alpha1.Registry{}.APIVersion, cloudiotv1alpha1.Registry{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudiotv1alpha1.Registry{}).
