...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=disks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=disks/status,verbs=get;update;patch
...
func (r *DiskReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.Disk{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.Disk{}.APIVersion, computev1alpha1.Disk{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.Disk{}).
...
func (r *DiskReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Disk")
			return nil
		}
		...
		resourceList := &computev1alpha1.DiskList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Disk")
			return nil
		}
