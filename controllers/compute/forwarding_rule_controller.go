...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=forwardingrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=forwardingrules/status,verbs=get;update;patch
...
func (r *ForwardingRuleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.ForwardingRule{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.ForwardingRule{}.APIVersion, computev1alpha1.ForwardingRule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.ForwardingRule{}).
