...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=healthchecks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=healthchecks/status,verbs=get;update;patch
...
func (r *HealthCheckReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.HealthCheck{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.HealthCheck{}.APIVersion, computev1alpha1.HealthCheck{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.HealthCheck{}).
