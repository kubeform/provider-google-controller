...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=images,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=images/status,verbs=get;update;patch
...
func (r *ImageReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.Image{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.Image{}.APIVersion, computev1alpha1.Image{}.Kind)
			return err
		}
	}
