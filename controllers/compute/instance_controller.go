...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=instances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=instances/status,verbs=get;update;patch
...
func (r *InstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.Instance{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.Instance{}.APIVersion, computev1alpha1.Instance{}.Kind)
			return err
		}
	}
...
func (r *InstanceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &computev1alpha1.InstanceList{}
