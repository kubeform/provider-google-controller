...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=instancegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=instancegroups/status,verbs=get;update;patch
...
func (r *InstanceGroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.InstanceGroup{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.InstanceGroup{}.APIVersion, computev1alpha1.InstanceGroup{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.InstanceGroup{}).
