...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=networks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=networks/status,verbs=get;update;patch
...
func (r *NetworkReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.Network{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.Network{}.APIVersion, computev1alpha1.Network{}.Kind)
			return err
		}
	}
