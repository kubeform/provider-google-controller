...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=routes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=routes/status,verbs=get;update;patch
...
func (r *RouteReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.Route{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.Route{}.APIVersion, computev1alpha1.Route{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.Route{}).
