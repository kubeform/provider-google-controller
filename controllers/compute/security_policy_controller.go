...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=securitypolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=securitypolicies/status,verbs=get;update;patch
...
func (r *SecurityPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &computev1alpha1.SecurityPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", computev1alpha1.SecurityPolicy{}.APIVersion, computev1alpha1.SecurityPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&computev1alpha1.SecurityPolicy{}).
