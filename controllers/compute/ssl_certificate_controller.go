...
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=sslcertificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=compute.google.kubeform.com,resources=sslcertificates/status,verbs=get;update;patch
...
func (r *SslCertificateReconciler) SetupWithManager(mgr ctrl.Manager) error {
