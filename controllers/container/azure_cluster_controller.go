...
// +kubebuilder:rbac:groups=container.google.kubeform.com,resources=azureclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=container.google.kubeform.com,resources=azureclusters/status,verbs=get;update;patch
...
func (r *AzureClusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch AzureCluster")
...
func (r *AzureClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &containerv1alpha1.AzureCluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", containerv1alpha1.AzureCluster{}.APIVersion, containerv1alpha1.AzureCluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&containerv1alpha1.AzureCluster{}).
