...
// +kubebuilder:rbac:groups=container.google.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=container.google.kubeform.com,resources=clusters/status,verbs=get;update;patch
