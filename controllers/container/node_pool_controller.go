...
// +kubebuilder:rbac:groups=container.google.kubeform.com,resources=nodepools,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=container.google.kubeform.com,resources=nodepools/status,verbs=get;update;patch
...
func (r *NodePoolReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &containerv1alpha1.NodePool{}); err != nil {
			klog.Error(err, "unable to set up auditor", containerv1alpha1.NodePool{}.APIVersion, containerv1alpha1.NodePool{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&containerv1alpha1.NodePool{}).
