...
// +kubebuilder:rbac:groups=data.google.kubeform.com,resources=catalogentries,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=data.google.kubeform.com,resources=catalogentries/status,verbs=get;update;patch
...
func (r *CatalogEntryReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch CatalogEntry")
...
func (r *CatalogEntryReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &datav1alpha1.CatalogEntry{}); err != nil {
			klog.Error(err, "unable to set up auditor", datav1alpha1.CatalogEntry{}.APIVersion, datav1alpha1.CatalogEntry{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&datav1alpha1.CatalogEntry{}).
