...
// +kubebuilder:rbac:groups=dataflow.google.kubeform.com,resources=jobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dataflow.google.kubeform.com,resources=jobs/status,verbs=get;update;patch
...
func (r *JobReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dataflowv1alpha1.Job{}); err != nil {
			klog.Error(err, "unable to set up auditor", dataflowv1alpha1.Job{}.APIVersion, dataflowv1alpha1.Job{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dataflowv1alpha1.Job{}).
