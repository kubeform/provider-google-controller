...
// +kubebuilder:rbac:groups=dataproc.google.kubeform.com,resources=workflowtemplates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dataproc.google.kubeform.com,resources=workflowtemplates/status,verbs=get;update;patch
...
func (r *WorkflowTemplateReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dataprocv1alpha1.WorkflowTemplate{}); err != nil {
			klog.Error(err, "unable to set up auditor", dataprocv1alpha1.WorkflowTemplate{}.APIVersion, dataprocv1alpha1.WorkflowTemplate{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dataprocv1alpha1.WorkflowTemplate{}).
