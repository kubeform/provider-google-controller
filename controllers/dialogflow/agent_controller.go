...
// +kubebuilder:rbac:groups=dialogflow.google.kubeform.com,resources=agents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dialogflow.google.kubeform.com,resources=agents/status,verbs=get;update;patch
...
func (r *AgentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dialogflowv1alpha1.Agent{}); err != nil {
			klog.Error(err, "unable to set up auditor", dialogflowv1alpha1.Agent{}.APIVersion, dialogflowv1alpha1.Agent{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dialogflowv1alpha1.Agent{}).
