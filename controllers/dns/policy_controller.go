...
// +kubebuilder:rbac:groups=dns.google.kubeform.com,resources=policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.google.kubeform.com,resources=policies/status,verbs=get;update;patch
...
func (r *PolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.Policy{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.Policy{}.APIVersion, dnsv1alpha1.Policy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&dnsv1alpha1.Policy{}).
