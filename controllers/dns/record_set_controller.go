...
// +kubebuilder:rbac:groups=dns.google.kubeform.com,resources=recordsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dns.google.kubeform.com,resources=recordsets/status,verbs=get;update;patch
...
func (r *RecordSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch RecordSet")
...
func (r *RecordSetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &dnsv1alpha1.RecordSet{}); err != nil {
			klog.Error(err, "unable to set up auditor", dnsv1alpha1.RecordSet{}.APIVersion, dnsv1alpha1.RecordSet{}.Kind)
			return err
		}
	}
