...
// +kubebuilder:rbac:groups=eventarc.google.kubeform.com,resources=triggers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eventarc.google.kubeform.com,resources=triggers/status,verbs=get;update;patch
...
func (r *TriggerReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &eventarcv1alpha1.Trigger{}); err != nil {
			klog.Error(err, "unable to set up auditor", eventarcv1alpha1.Trigger{}.APIVersion, eventarcv1alpha1.Trigger{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&eventarcv1alpha1.Trigger{}).
