...
// +kubebuilder:rbac:groups=filestore.google.kubeform.com,resources=instances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=filestore.google.kubeform.com,resources=instances/status,verbs=get;update;patch
...
func (r *InstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &filestorev1alpha1.Instance{}); err != nil {
			klog.Error(err, "unable to set up auditor", filestorev1alpha1.Instance{}.APIVersion, filestorev1alpha1.Instance{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&filestorev1alpha1.Instance{}).
