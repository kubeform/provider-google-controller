...
// +kubebuilder:rbac:groups=firestore.google.kubeform.com,resources=documents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=firestore.google.kubeform.com,resources=documents/status,verbs=get;update;patch
...
func (r *DocumentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &firestorev1alpha1.Document{}); err != nil {
			klog.Error(err, "unable to set up auditor", firestorev1alpha1.Document{}.APIVersion, firestorev1alpha1.Document{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&firestorev1alpha1.Document{}).
