...
// +kubebuilder:rbac:groups=firestore.google.kubeform.com,resources=indices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=firestore.google.kubeform.com,resources=indices/status,verbs=get;update;patch
...
func (r *IndexReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &firestorev1alpha1.Index{}); err != nil {
			klog.Error(err, "unable to set up auditor", firestorev1alpha1.Index{}.APIVersion, firestorev1alpha1.Index{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&firestorev1alpha1.Index{}).
