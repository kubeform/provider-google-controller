...
// +kubebuilder:rbac:groups=folder.google.kubeform.com,resources=organizationpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=folder.google.kubeform.com,resources=organizationpolicies/status,verbs=get;update;patch
...
func (r *OrganizationPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &folderv1alpha1.OrganizationPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", folderv1alpha1.OrganizationPolicy{}.APIVersion, folderv1alpha1.OrganizationPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&folderv1alpha1.OrganizationPolicy{}).
