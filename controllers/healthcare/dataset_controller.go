...
// +kubebuilder:rbac:groups=healthcare.google.kubeform.com,resources=datasets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=healthcare.google.kubeform.com,resources=datasets/status,verbs=get;update;patch
...
func (r *DatasetReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &healthcarev1alpha1.Dataset{}); err != nil {
			klog.Error(err, "unable to set up auditor", healthcarev1alpha1.Dataset{}.APIVersion, healthcarev1alpha1.Dataset{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&healthcarev1alpha1.Dataset{}).
