...
// Hl7V2StoreIamMemberReconciler reconciles a Hl7V2StoreIamMember object
type Hl7V2StoreIamMemberReconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=healthcare.google.kubeform.com,resources=hl7v2storeiammembers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=healthcare.google.kubeform.com,resources=hl7v2storeiammembers/status,verbs=get;update;patch

func (r *Hl7V2StoreIamMemberReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("hl7v2storeiammember", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Hl7V2StoreIamMember")
...
func (r *Hl7V2StoreIamMemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &healthcarev1alpha1.Hl7V2StoreIamMember{}); err != nil {
			klog.Error(err, "unable to set up auditor", healthcarev1alpha1.Hl7V2StoreIamMember{}.APIVersion, healthcarev1alpha1.Hl7V2StoreIamMember{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&healthcarev1alpha1.Hl7V2StoreIamMember{}).
