...
// +kubebuilder:rbac:groups=iap.google.kubeform.com,resources=clients,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iap.google.kubeform.com,resources=clients/status,verbs=get;update;patch
...
func (r *ClientReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iapv1alpha1.Client{}); err != nil {
			klog.Error(err, "unable to set up auditor", iapv1alpha1.Client{}.APIVersion, iapv1alpha1.Client{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iapv1alpha1.Client{}).
...
func (r *ClientReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for Client")
			return nil
		}
		...
		resourceList := &iapv1alpha1.ClientList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list Client")
			return nil
		}
