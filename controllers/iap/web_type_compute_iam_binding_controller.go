...
// WebTypeComputeIamBindingReconciler reconciles a WebTypeComputeIamBinding object
type WebTypeComputeIamBindingReconciler struct {
	client.Client
	Log    logr.Logger
...
// +kubebuilder:rbac:groups=iap.google.kubeform.com,resources=webtypecomputeiambindings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iap.google.kubeform.com,resources=webtypecomputeiambindings/status,verbs=get;update;patch

func (r *WebTypeComputeIamBindingReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("webtypecomputeiambinding", req.NamespacedName)

	var unstructuredObj unstructured.Unstructured
	unstructuredObj.SetGroupVersionKind(r.Gvk)

	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch WebTypeComputeIamBinding")
...
func (r *WebTypeComputeIamBindingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iapv1alpha1.WebTypeComputeIamBinding{}); err != nil {
			klog.Error(err, "unable to set up auditor", iapv1alpha1.WebTypeComputeIamBinding{}.APIVersion, iapv1alpha1.WebTypeComputeIamBinding{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iapv1alpha1.WebTypeComputeIamBinding{}).
