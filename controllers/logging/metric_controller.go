...
// +kubebuilder:rbac:groups=logging.google.kubeform.com,resources=metrics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=logging.google.kubeform.com,resources=metrics/status,verbs=get;update;patch
...
func (r *MetricReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &loggingv1alpha1.Metric{}); err != nil {
			klog.Error(err, "unable to set up auditor", loggingv1alpha1.Metric{}.APIVersion, loggingv1alpha1.Metric{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&loggingv1alpha1.Metric{}).
