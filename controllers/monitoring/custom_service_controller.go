...
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=customservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=customservices/status,verbs=get;update;patch

func (r *CustomServiceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := r.Log.WithValues("customservice", req.NamespacedName)
...
func (r *CustomServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &monitoringv1alpha1.CustomService{}); err != nil {
			klog.Error(err, "unable to set up auditor", monitoringv1alpha1.CustomService{}.APIVersion, monitoringv1alpha1.CustomService{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&monitoringv1alpha1.CustomService{}).
