...
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=dashboards,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=dashboards/status,verbs=get;update;patch
...
func (r *DashboardReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &monitoringv1alpha1.Dashboard{}); err != nil {
			klog.Error(err, "unable to set up auditor", monitoringv1alpha1.Dashboard{}.APIVersion, monitoringv1alpha1.Dashboard{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&monitoringv1alpha1.Dashboard{}).
