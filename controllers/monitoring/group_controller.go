...
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=groups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=groups/status,verbs=get;update;patch
...
func (r *GroupReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &monitoringv1alpha1.Group{}); err != nil {
			klog.Error(err, "unable to set up auditor", monitoringv1alpha1.Group{}.APIVersion, monitoringv1alpha1.Group{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&monitoringv1alpha1.Group{}).
