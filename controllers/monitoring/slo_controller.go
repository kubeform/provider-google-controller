...
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=sloes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=monitoring.google.kubeform.com,resources=sloes/status,verbs=get;update;patch
...
func (r *SloReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &monitoringv1alpha1.Slo{}); err != nil {
			klog.Error(err, "unable to set up auditor", monitoringv1alpha1.Slo{}.APIVersion, monitoringv1alpha1.Slo{}.Kind)
			return err
		}
	}
