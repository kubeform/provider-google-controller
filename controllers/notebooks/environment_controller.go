...
// +kubebuilder:rbac:groups=notebooks.google.kubeform.com,resources=environments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=notebooks.google.kubeform.com,resources=environments/status,verbs=get;update;patch
...
func (r *EnvironmentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &notebooksv1alpha1.Environment{}); err != nil {
			klog.Error(err, "unable to set up auditor", notebooksv1alpha1.Environment{}.APIVersion, notebooksv1alpha1.Environment{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&notebooksv1alpha1.Environment{}).
