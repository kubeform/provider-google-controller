...
// +kubebuilder:rbac:groups=notebooks.google.kubeform.com,resources=locations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=notebooks.google.kubeform.com,resources=locations/status,verbs=get;update;patch
...
func (r *LocationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &notebooksv1alpha1.Location{}); err != nil {
			klog.Error(err, "unable to set up auditor", notebooksv1alpha1.Location{}.APIVersion, notebooksv1alpha1.Location{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&notebooksv1alpha1.Location{}).
