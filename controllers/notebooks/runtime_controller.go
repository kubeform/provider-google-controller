...
// +kubebuilder:rbac:groups=notebooks.google.kubeform.com,resources=runtimes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=notebooks.google.kubeform.com,resources=runtimes/status,verbs=get;update;patch
...
func (r *RuntimeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &notebooksv1alpha1.Runtime{}); err != nil {
			klog.Error(err, "unable to set up auditor", notebooksv1alpha1.Runtime{}.APIVersion, notebooksv1alpha1.Runtime{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&notebooksv1alpha1.Runtime{}).
