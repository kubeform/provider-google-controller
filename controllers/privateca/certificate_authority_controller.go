...
// +kubebuilder:rbac:groups=privateca.google.kubeform.com,resources=certificateauthorities,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=privateca.google.kubeform.com,resources=certificateauthorities/status,verbs=get;update;patch
...
func (r *CertificateAuthorityReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &privatecav1alpha1.CertificateAuthority{}); err != nil {
			klog.Error(err, "unable to set up auditor", privatecav1alpha1.CertificateAuthority{}.APIVersion, privatecav1alpha1.CertificateAuthority{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&privatecav1alpha1.CertificateAuthority{}).
