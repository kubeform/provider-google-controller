...
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=iamcustomroles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=iamcustomroles/status,verbs=get;update;patch
...
func (r *IamCustomRoleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &projectv1alpha1.IamCustomRole{}); err != nil {
			klog.Error(err, "unable to set up auditor", projectv1alpha1.IamCustomRole{}.APIVersion, projectv1alpha1.IamCustomRole{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&projectv1alpha1.IamCustomRole{}).
