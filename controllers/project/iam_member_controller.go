...
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=iammembers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=iammembers/status,verbs=get;update;patch
...
func (r *IamMemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &projectv1alpha1.IamMember{}); err != nil {
			klog.Error(err, "unable to set up auditor", projectv1alpha1.IamMember{}.APIVersion, projectv1alpha1.IamMember{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&projectv1alpha1.IamMember{}).
