...
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=iampolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=iampolicies/status,verbs=get;update;patch
...
func (r *IamPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &projectv1alpha1.IamPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", projectv1alpha1.IamPolicy{}.APIVersion, projectv1alpha1.IamPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&projectv1alpha1.IamPolicy{}).
