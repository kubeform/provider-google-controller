...
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=project.google.kubeform.com,resources=projects/status,verbs=get;update;patch
