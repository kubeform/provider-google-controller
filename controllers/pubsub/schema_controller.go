...
// +kubebuilder:rbac:groups=pubsub.google.kubeform.com,resources=schemas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pubsub.google.kubeform.com,resources=schemas/status,verbs=get;update;patch
...
func (r *SchemaReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &pubsubv1alpha1.Schema{}); err != nil {
			klog.Error(err, "unable to set up auditor", pubsubv1alpha1.Schema{}.APIVersion, pubsubv1alpha1.Schema{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&pubsubv1alpha1.Schema{}).
