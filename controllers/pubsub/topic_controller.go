...
// +kubebuilder:rbac:groups=pubsub.google.kubeform.com,resources=topics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pubsub.google.kubeform.com,resources=topics/status,verbs=get;update;patch
...
func (r *TopicReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &pubsubv1alpha1.Topic{}); err != nil {
			klog.Error(err, "unable to set up auditor", pubsubv1alpha1.Topic{}.APIVersion, pubsubv1alpha1.Topic{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&pubsubv1alpha1.Topic{}).
