...
// +kubebuilder:rbac:groups=runtimeconfig.google.kubeform.com,resources=configs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=runtimeconfig.google.kubeform.com,resources=configs/status,verbs=get;update;patch
...
func (r *ConfigReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &runtimeconfigv1alpha1.Config{}); err != nil {
			klog.Error(err, "unable to set up auditor", runtimeconfigv1alpha1.Config{}.APIVersion, runtimeconfigv1alpha1.Config{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&runtimeconfigv1alpha1.Config{}).
