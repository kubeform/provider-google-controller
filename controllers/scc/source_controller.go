...
// +kubebuilder:rbac:groups=scc.google.kubeform.com,resources=sources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=scc.google.kubeform.com,resources=sources/status,verbs=get;update;patch
...
func (r *SourceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch Source")
...
func (r *SourceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sccv1alpha1.Source{}); err != nil {
			klog.Error(err, "unable to set up auditor", sccv1alpha1.Source{}.APIVersion, sccv1alpha1.Source{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sccv1alpha1.Source{}).
