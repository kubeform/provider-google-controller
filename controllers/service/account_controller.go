...
// +kubebuilder:rbac:groups=service.google.kubeform.com,resources=accounts,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=service.google.kubeform.com,resources=accounts/status,verbs=get;update;patch
