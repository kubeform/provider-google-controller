...
// +kubebuilder:rbac:groups=sourcereporepository.google.kubeform.com,resources=iammembers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sourcereporepository.google.kubeform.com,resources=iammembers/status,verbs=get;update;patch
...
func (r *IamMemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sourcereporepositoryv1alpha1.IamMember{}); err != nil {
			klog.Error(err, "unable to set up auditor", sourcereporepositoryv1alpha1.IamMember{}.APIVersion, sourcereporepositoryv1alpha1.IamMember{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sourcereporepositoryv1alpha1.IamMember{}).
