...
// +kubebuilder:rbac:groups=sourcereporepository.google.kubeform.com,resources=iampolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sourcereporepository.google.kubeform.com,resources=iampolicies/status,verbs=get;update;patch
...
func (r *IamPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sourcereporepositoryv1alpha1.IamPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", sourcereporepositoryv1alpha1.IamPolicy{}.APIVersion, sourcereporepositoryv1alpha1.IamPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sourcereporepositoryv1alpha1.IamPolicy{}).
