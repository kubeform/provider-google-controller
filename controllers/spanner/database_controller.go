...
// +kubebuilder:rbac:groups=spanner.google.kubeform.com,resources=databases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=spanner.google.kubeform.com,resources=databases/status,verbs=get;update;patch
...
func (r *DatabaseReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &spannerv1alpha1.Database{}); err != nil {
			klog.Error(err, "unable to set up auditor", spannerv1alpha1.Database{}.APIVersion, spannerv1alpha1.Database{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&spannerv1alpha1.Database{}).
