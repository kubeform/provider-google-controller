...
// +kubebuilder:rbac:groups=spanner.google.kubeform.com,resources=instanceiammembers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=spanner.google.kubeform.com,resources=instanceiammembers/status,verbs=get;update;patch
...
func (r *InstanceIamMemberReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &spannerv1alpha1.InstanceIamMember{}); err != nil {
			klog.Error(err, "unable to set up auditor", spannerv1alpha1.InstanceIamMember{}.APIVersion, spannerv1alpha1.InstanceIamMember{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&spannerv1alpha1.InstanceIamMember{}).
