...
// +kubebuilder:rbac:groups=spanner.google.kubeform.com,resources=instanceiampolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=spanner.google.kubeform.com,resources=instanceiampolicies/status,verbs=get;update;patch
...
func (r *InstanceIamPolicyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &spannerv1alpha1.InstanceIamPolicy{}); err != nil {
			klog.Error(err, "unable to set up auditor", spannerv1alpha1.InstanceIamPolicy{}.APIVersion, spannerv1alpha1.InstanceIamPolicy{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&spannerv1alpha1.InstanceIamPolicy{}).
