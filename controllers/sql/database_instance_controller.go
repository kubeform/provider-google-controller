...
// +kubebuilder:rbac:groups=sql.google.kubeform.com,resources=databaseinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sql.google.kubeform.com,resources=databaseinstances/status,verbs=get;update;patch
...
func (r *DatabaseInstanceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sqlv1alpha1.DatabaseInstance{}); err != nil {
			klog.Error(err, "unable to set up auditor", sqlv1alpha1.DatabaseInstance{}.APIVersion, sqlv1alpha1.DatabaseInstance{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sqlv1alpha1.DatabaseInstance{}).
...
func (r *DatabaseInstanceReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for DatabaseInstance")
			return nil
		}
		...
		resourceList := &sqlv1alpha1.DatabaseInstanceList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list DatabaseInstance")
			return nil
		}
