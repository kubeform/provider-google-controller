...
// +kubebuilder:rbac:groups=sql.google.kubeform.com,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sql.google.kubeform.com,resources=users/status,verbs=get;update;patch
...
func (r *UserReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &sqlv1alpha1.User{}); err != nil {
			klog.Error(err, "unable to set up auditor", sqlv1alpha1.User{}.APIVersion, sqlv1alpha1.User{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&sqlv1alpha1.User{}).
...
func (r *UserReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &sqlv1alpha1.UserList{}
