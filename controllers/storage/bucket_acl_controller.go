...
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=bucketacls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=bucketacls/status,verbs=get;update;patch
...
func (r *BucketACLReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.BucketACL{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.BucketACL{}.APIVersion, storagev1alpha1.BucketACL{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.BucketACL{}).
