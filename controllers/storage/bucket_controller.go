...
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=buckets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=buckets/status,verbs=get;update;patch
...
func (r *BucketReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Bucket{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Bucket{}.APIVersion, storagev1alpha1.Bucket{}.Kind)
			return err
		}
	}
