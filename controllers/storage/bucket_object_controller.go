...
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=bucketobjects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=bucketobjects/status,verbs=get;update;patch
...
func (r *BucketObjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.BucketObject{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.BucketObject{}.APIVersion, storagev1alpha1.BucketObject{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.BucketObject{}).
...
func (r *BucketObjectReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(errors.Errorf("expected a Secret but go a %T", o), "failed to get secret for BucketObject")
			return nil
		}
		...
		resourceList := &storagev1alpha1.BucketObjectList{}
		if err := r.List(ctx, resourceList, client.InNamespace(secNamespace)); err != nil {
			log.Error(err, "failed to list BucketObject")
			return nil
		}
