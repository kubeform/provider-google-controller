...
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=notifications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=storage.google.kubeform.com,resources=notifications/status,verbs=get;update;patch
...
func (r *NotificationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &storagev1alpha1.Notification{}); err != nil {
			klog.Error(err, "unable to set up auditor", storagev1alpha1.Notification{}.APIVersion, storagev1alpha1.Notification{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&storagev1alpha1.Notification{}).
