...
// +kubebuilder:rbac:groups=tpu.google.kubeform.com,resources=nodes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=tpu.google.kubeform.com,resources=nodes/status,verbs=get;update;patch
...
func (r *NodeReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &tpuv1alpha1.Node{}); err != nil {
			klog.Error(err, "unable to set up auditor", tpuv1alpha1.Node{}.APIVersion, tpuv1alpha1.Node{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&tpuv1alpha1.Node{}).
