...
import (
	...
	googlescheme "kubeform.dev/provider-google-api/client/clientset/versioned/scheme"
...
func init() {
	...
	_ = googlescheme.AddToScheme(scheme)
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "5b87adeb.google.kubeform.com", // 5b87adeb needs to be dynamically generated for each controller
			})
			if err != nil {
