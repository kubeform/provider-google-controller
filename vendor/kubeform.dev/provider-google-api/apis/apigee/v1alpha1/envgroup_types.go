...
type EnvgroupSpec struct {
	KubeformOutput *EnvgroupSpecResource `json:"kubeformOutput,omitempty" tf:"-"`

	Resource EnvgroupSpecResource `json:"resource" tf:"resource"`
...
type EnvgroupSpecResource struct {
