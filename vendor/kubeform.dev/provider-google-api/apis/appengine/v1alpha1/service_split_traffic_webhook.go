...
var servicesplittrafficForceNewList = map[string]bool{
	"/project": true,
}
...
func (r *ServiceSplitTraffic) ValidateUpdate(old runtime.Object) error {
	...
	for key := range servicesplittrafficForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`servicesplittraffic "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
