...
func (in *CloudfunctionsFunctionSpecResource) DeepCopyInto(out *CloudfunctionsFunctionSpecResource) {
	*out = *in
	...
	if in.SecretEnvironmentVariables != nil {
		...
		*out = make([]CloudfunctionsFunctionSpecSecretEnvironmentVariables, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SecretVolumes != nil {
		...
		*out = make([]CloudfunctionsFunctionSpecSecretVolumes, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CloudfunctionsFunctionSpecSecretEnvironmentVariables) DeepCopy() *CloudfunctionsFunctionSpecSecretEnvironmentVariables {
	...
	out := new(CloudfunctionsFunctionSpecSecretEnvironmentVariables)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloudfunctionsFunctionSpecSecretVolumes) DeepCopyInto(out *CloudfunctionsFunctionSpecSecretVolumes) {
	*out = *in
	...
	if in.Versions != nil {
		...
		*out = make([]CloudfunctionsFunctionSpecSecretVolumesVersions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CloudfunctionsFunctionSpecSecretVolumes) DeepCopy() *CloudfunctionsFunctionSpecSecretVolumes {
	...
	out := new(CloudfunctionsFunctionSpecSecretVolumes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CloudfunctionsFunctionSpecSecretVolumesVersions) DeepCopy() *CloudfunctionsFunctionSpecSecretVolumesVersions {
	...
	out := new(CloudfunctionsFunctionSpecSecretVolumesVersions)
	in.DeepCopyInto(out)
	return out
}
