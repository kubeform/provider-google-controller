...
func (in *EnvironmentSpecConfig) DeepCopyInto(out *EnvironmentSpecConfig) {
	*out = *in
	...
	if in.DatabaseConfig != nil {
		...
		*out = new(EnvironmentSpecConfigDatabaseConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.EncryptionConfig != nil {
		in, out := &in.EncryptionConfig, &out.EncryptionConfig
		*out = new(EnvironmentSpecConfigEncryptionConfig)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.MaintenanceWindow != nil {
		...
		*out = new(EnvironmentSpecConfigMaintenanceWindow)
		(*in).DeepCopyInto(*out)
	}
...
func (in *EnvironmentSpecConfigWebServerNetworkAccessControl) DeepCopyInto(out *EnvironmentSpecConfigWebServerNetworkAccessControl) {
	*out = *in
	if in.AllowedIPRange != nil {
		...
		*out = make([]EnvironmentSpecConfigWebServerNetworkAccessControlAllowedIPRange, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EnvironmentSpecConfigWebServerNetworkAccessControlAllowedIPRange) DeepCopy() *EnvironmentSpecConfigWebServerNetworkAccessControlAllowedIPRange {
	...
	out := new(EnvironmentSpecConfigWebServerNetworkAccessControlAllowedIPRange)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EnvironmentSpecConfigWorkloadsConfig) DeepCopyInto(out *EnvironmentSpecConfigWorkloadsConfig) {
	*out = *in
	if in.Scheduler != nil {
		...
		*out = new(EnvironmentSpecConfigWorkloadsConfigScheduler)
		(*in).DeepCopyInto(*out)
	}
	if in.WebServer != nil {
		in, out := &in.WebServer, &out.WebServer
		*out = new(EnvironmentSpecConfigWorkloadsConfigWebServer)
		(*in).DeepCopyInto(*out)
	}
	if in.Worker != nil {
		in, out := &in.Worker, &out.Worker
		*out = new(EnvironmentSpecConfigWorkloadsConfigWorker)
		(*in).DeepCopyInto(*out)
	}
	return
}
