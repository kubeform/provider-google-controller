...
var targethttpproxyForceNewList = map[string]bool{
	"/description": true,
	"/name":        true,
	"/project":     true,
	"/proxy_bind":  true,
...
func (r *TargetHTTPProxy) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range targethttpproxyForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`targethttpproxy "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
