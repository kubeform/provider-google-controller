...
func (in *ContactsContactList) DeepCopyInto(out *ContactsContactList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]ContactsContact, len(*in))
		for i := range *in {
...
func (in *ContactsContactSpec) DeepCopyInto(out *ContactsContactSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(ContactsContactSpecResource)
		(*in).DeepCopyInto(*out)
	}
