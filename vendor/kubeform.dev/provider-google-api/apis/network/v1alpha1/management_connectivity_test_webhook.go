...
var managementconnectivitytestForceNewList = map[string]bool{
	"/name":    true,
	"/project": true,
}
...
func (r *ManagementConnectivityTest) ValidateUpdate(old runtime.Object) error {
	...
	res := old.(*ManagementConnectivityTest)
	...
	for key, _ := range managementconnectivitytestForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`managementconnectivitytest "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
