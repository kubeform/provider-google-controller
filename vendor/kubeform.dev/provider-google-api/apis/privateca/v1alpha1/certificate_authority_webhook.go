...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-privateca-google-kubeform-com-v1alpha1-certificateauthority,mutating=false,failurePolicy=fail,groups=privateca.google.kubeform.com,resources=certificateauthorities,versions=v1alpha1,name=certificateauthority.privateca.google.kubeform.io,sideEffects=None,admissionReviewVersions=v1

var _ webhook.Validator = &CertificateAuthority{}

var certificateauthorityForceNewList = map[string]bool{
	"/certificate_authority_id":                                                        true,
	...
	"/key_spec/*/algorithm":                   true,
	"/key_spec/*/cloud_kms_key_version":       true,
	"/labels":                                 true,
	"/lifetime":                               true,
	"/location":                               true,
	"/pool":                                   true,
