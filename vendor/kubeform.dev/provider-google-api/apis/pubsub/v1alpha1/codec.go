...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		...
		jsoniter.MustGetKind(reflect2.TypeOf(TopicSpecSchemaSettings{}).Type1()):              TopicSpecSchemaSettingsCodec{},
...
func (LiteSubscriptionSpecDeliveryConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj LiteSubscriptionSpecDeliveryConfig
			...
			*(*LiteSubscriptionSpecDeliveryConfig)(ptr) = obj
		} else {
			*(*LiteSubscriptionSpecDeliveryConfig)(ptr) = LiteSubscriptionSpecDeliveryConfig{}
		}
	default:
...
func (LiteTopicSpecPartitionConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj LiteTopicSpecPartitionConfig
			...
			*(*LiteTopicSpecPartitionConfig)(ptr) = obj
		} else {
			*(*LiteTopicSpecPartitionConfig)(ptr) = LiteTopicSpecPartitionConfig{}
		}
	default:
...
func (LiteTopicSpecPartitionConfigCapacityCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj LiteTopicSpecPartitionConfigCapacity
			...
			*(*LiteTopicSpecPartitionConfigCapacity)(ptr) = obj
		} else {
			*(*LiteTopicSpecPartitionConfigCapacity)(ptr) = LiteTopicSpecPartitionConfigCapacity{}
		}
	default:
...
func (LiteTopicSpecRetentionConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj LiteTopicSpecRetentionConfig
			...
			*(*LiteTopicSpecRetentionConfig)(ptr) = obj
		} else {
			*(*LiteTopicSpecRetentionConfig)(ptr) = LiteTopicSpecRetentionConfig{}
		}
	default:
...
func (SubscriptionSpecDeadLetterPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SubscriptionSpecDeadLetterPolicy
			...
			*(*SubscriptionSpecDeadLetterPolicy)(ptr) = obj
		} else {
			*(*SubscriptionSpecDeadLetterPolicy)(ptr) = SubscriptionSpecDeadLetterPolicy{}
		}
	default:
...
func (SubscriptionSpecExpirationPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SubscriptionSpecExpirationPolicy
			...
			*(*SubscriptionSpecExpirationPolicy)(ptr) = obj
		} else {
			*(*SubscriptionSpecExpirationPolicy)(ptr) = SubscriptionSpecExpirationPolicy{}
		}
	default:
...
func (SubscriptionSpecPushConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SubscriptionSpecPushConfig
			...
			*(*SubscriptionSpecPushConfig)(ptr) = obj
		} else {
			*(*SubscriptionSpecPushConfig)(ptr) = SubscriptionSpecPushConfig{}
		}
	default:
...
func (SubscriptionSpecPushConfigOidcTokenCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SubscriptionSpecPushConfigOidcToken
			...
			*(*SubscriptionSpecPushConfigOidcToken)(ptr) = obj
		} else {
			*(*SubscriptionSpecPushConfigOidcToken)(ptr) = SubscriptionSpecPushConfigOidcToken{}
		}
	default:
...
func (SubscriptionSpecRetryPolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SubscriptionSpecRetryPolicy
			...
			*(*SubscriptionSpecRetryPolicy)(ptr) = obj
		} else {
			*(*SubscriptionSpecRetryPolicy)(ptr) = SubscriptionSpecRetryPolicy{}
		}
	default:
...
func (SubscriptionIamBindingSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SubscriptionIamBindingSpecCondition
			...
			*(*SubscriptionIamBindingSpecCondition)(ptr) = obj
		} else {
			*(*SubscriptionIamBindingSpecCondition)(ptr) = SubscriptionIamBindingSpecCondition{}
		}
	default:
...
func (SubscriptionIamMemberSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj SubscriptionIamMemberSpecCondition
			...
			*(*SubscriptionIamMemberSpecCondition)(ptr) = obj
		} else {
			*(*SubscriptionIamMemberSpecCondition)(ptr) = SubscriptionIamMemberSpecCondition{}
		}
	default:
...
func (TopicSpecMessageStoragePolicyCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj TopicSpecMessageStoragePolicy
			...
			*(*TopicSpecMessageStoragePolicy)(ptr) = obj
		} else {
			*(*TopicSpecMessageStoragePolicy)(ptr) = TopicSpecMessageStoragePolicy{}
		}
	default:
...
func (TopicSpecSchemaSettingsCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*TopicSpecSchemaSettings)(ptr) == nil
}

func (TopicSpecSchemaSettingsCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*TopicSpecSchemaSettings)(ptr)
	var objs []TopicSpecSchemaSettings
	if obj != nil {
		objs = []TopicSpecSchemaSettings{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(TopicSpecSchemaSettings{}).Type1())),
	}.Froze()
...
func (TopicSpecSchemaSettingsCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*TopicSpecSchemaSettings)(ptr) = TopicSpecSchemaSettings{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(TopicSpecSchemaSettings{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*TopicSpecSchemaSettings)(ptr) = objs[0]
			} else {
				*(*TopicSpecSchemaSettings)(ptr) = TopicSpecSchemaSettings{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj TopicSpecSchemaSettings
			...
			*(*TopicSpecSchemaSettings)(ptr) = obj
		} else {
			*(*TopicSpecSchemaSettings)(ptr) = TopicSpecSchemaSettings{}
		}
	default:
		iter.ReportError("decode TopicSpecSchemaSettings", "unexpected JSON type")
	}
}
...
func (TopicIamBindingSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj TopicIamBindingSpecCondition
			...
			*(*TopicIamBindingSpecCondition)(ptr) = obj
		} else {
			*(*TopicIamBindingSpecCondition)(ptr) = TopicIamBindingSpecCondition{}
		}
	default:
...
func (TopicIamMemberSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj TopicIamMemberSpecCondition
			...
			*(*TopicIamMemberSpecCondition)(ptr) = obj
		} else {
			*(*TopicIamMemberSpecCondition)(ptr) = TopicIamMemberSpecCondition{}
		}
	default:
