...
func (in *LiteReservationSpec) DeepCopyInto(out *LiteReservationSpec) {
	*out = *in
	if in.State != nil {
		...
		*out = new(LiteReservationSpecResource)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LiteReservationSpecResource) DeepCopyInto(out *LiteReservationSpecResource) {
	*out = *in
	if in.Timeouts != nil {
...
func (in *LiteReservationSpecResource) DeepCopy() *LiteReservationSpecResource {
	if in == nil {
		return nil
	}
	out := new(LiteReservationSpecResource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LiteTopicSpecReservationConfig) DeepCopyInto(out *LiteTopicSpecReservationConfig) {
	*out = *in
...
func (in *LiteTopicSpecReservationConfig) DeepCopy() *LiteTopicSpecReservationConfig {
	if in == nil {
		return nil
	}
	out := new(LiteTopicSpecReservationConfig)
	in.DeepCopyInto(out)
	return out
}
