...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		...
		jsoniter.MustGetKind(reflect2.TypeOf(ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption{}).Type1()): ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryptionCodec{},
		jsoniter.MustGetKind(reflect2.TypeOf(ManagerSecretSpecRotation{}).Type1()):                                                ManagerSecretSpecRotationCodec{},
...
func (ManagerSecretSpecReplicationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj ManagerSecretSpecReplication
			...
			*(*ManagerSecretSpecReplication)(ptr) = obj
		} else {
			*(*ManagerSecretSpecReplication)(ptr) = ManagerSecretSpecReplication{}
		}
	default:
...
func (ManagerSecretSpecReplicationUserManagedCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagerSecretSpecReplicationUserManaged
			...
			*(*ManagerSecretSpecReplicationUserManaged)(ptr) = obj
		} else {
			*(*ManagerSecretSpecReplicationUserManaged)(ptr) = ManagerSecretSpecReplicationUserManaged{}
		}
	default:
...
func (ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryptionCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption)(ptr) == nil
}
...
func (ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryptionCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption)(ptr)
	var objs []ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption
	if obj != nil {
		objs = []ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption{}).Type1())),
	}.Froze()
...
func (ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryptionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption)(ptr) = ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption)(ptr) = objs[0]
			} else {
				*(*ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption)(ptr) = ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption
			...
			*(*ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption)(ptr) = obj
		} else {
			*(*ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption)(ptr) = ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption{}
		}
	default:
		iter.ReportError("decode ManagerSecretSpecReplicationUserManagedReplicasCustomerManagedEncryption", "unexpected JSON type")
	}
}
...
func (ManagerSecretSpecRotationCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*ManagerSecretSpecRotation)(ptr) == nil
}

func (ManagerSecretSpecRotationCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*ManagerSecretSpecRotation)(ptr)
	var objs []ManagerSecretSpecRotation
	if obj != nil {
		objs = []ManagerSecretSpecRotation{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		ValidateJsonRawMessage: true,
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ManagerSecretSpecRotation{}).Type1())),
	}.Froze()
...
func (ManagerSecretSpecRotationCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*ManagerSecretSpecRotation)(ptr) = ManagerSecretSpecRotation{}
		return
	case jsoniter.ArrayValue:
		objsByte := iter.SkipAndReturnBytes()
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(ManagerSecretSpecRotation{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*ManagerSecretSpecRotation)(ptr) = objs[0]
			} else {
				*(*ManagerSecretSpecRotation)(ptr) = ManagerSecretSpecRotation{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagerSecretSpecRotation
			...
			*(*ManagerSecretSpecRotation)(ptr) = obj
		} else {
			*(*ManagerSecretSpecRotation)(ptr) = ManagerSecretSpecRotation{}
		}
	default:
		iter.ReportError("decode ManagerSecretSpecRotation", "unexpected JSON type")
	}
}
...
func (ManagerSecretIamBindingSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagerSecretIamBindingSpecCondition
			...
			*(*ManagerSecretIamBindingSpecCondition)(ptr) = obj
		} else {
			*(*ManagerSecretIamBindingSpecCondition)(ptr) = ManagerSecretIamBindingSpecCondition{}
		}
	default:
...
func (ManagerSecretIamMemberSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj ManagerSecretIamMemberSpecCondition
			...
			*(*ManagerSecretIamMemberSpecCondition)(ptr) = obj
		} else {
			*(*ManagerSecretIamMemberSpecCondition)(ptr) = ManagerSecretIamMemberSpecCondition{}
		}
	default:
