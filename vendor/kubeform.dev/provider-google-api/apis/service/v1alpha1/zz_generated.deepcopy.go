...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkingPeeredDNSDomain) DeepCopyInto(out *NetworkingPeeredDNSDomain) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
func (in *NetworkingPeeredDNSDomain) DeepCopy() *NetworkingPeeredDNSDomain {
	if in == nil {
		return nil
	}
	out := new(NetworkingPeeredDNSDomain)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkingPeeredDNSDomainList) DeepCopyInto(out *NetworkingPeeredDNSDomainList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]NetworkingPeeredDNSDomain, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *NetworkingPeeredDNSDomainList) DeepCopy() *NetworkingPeeredDNSDomainList {
	if in == nil {
		return nil
	}
	out := new(NetworkingPeeredDNSDomainList)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkingPeeredDNSDomainSpec) DeepCopyInto(out *NetworkingPeeredDNSDomainSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(NetworkingPeeredDNSDomainSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *NetworkingPeeredDNSDomainSpec) DeepCopy() *NetworkingPeeredDNSDomainSpec {
	if in == nil {
		return nil
	}
	out := new(NetworkingPeeredDNSDomainSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkingPeeredDNSDomainSpecResource) DeepCopyInto(out *NetworkingPeeredDNSDomainSpecResource) {
	*out = *in
	if in.Timeouts != nil {
		in, out := &in.Timeouts, &out.Timeouts
		*out = new(apiv1alpha1.ResourceTimeout)
...
func (in *NetworkingPeeredDNSDomainSpecResource) DeepCopy() *NetworkingPeeredDNSDomainSpecResource {
	if in == nil {
		return nil
	}
	out := new(NetworkingPeeredDNSDomainSpecResource)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkingPeeredDNSDomainStatus) DeepCopyInto(out *NetworkingPeeredDNSDomainStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]apiv1.Condition, len(*in))
...
func (in *NetworkingPeeredDNSDomainStatus) DeepCopy() *NetworkingPeeredDNSDomainStatus {
	if in == nil {
		return nil
	}
	out := new(NetworkingPeeredDNSDomainStatus)
	in.DeepCopyInto(out)
	return out
}
