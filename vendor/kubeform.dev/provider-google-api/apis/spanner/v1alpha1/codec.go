...
func GetEncoder() map[string]jsoniter.ValEncoder {
	return map[string]jsoniter.ValEncoder{
		jsoniter.MustGetKind(reflect2.TypeOf(DatabaseSpecEncryptionConfig{}).Type1()):    DatabaseSpecEncryptionConfigCodec{},
...
func (DatabaseSpecEncryptionConfigCodec) IsEmpty(ptr unsafe.Pointer) bool {
	return (*DatabaseSpecEncryptionConfig)(ptr) == nil
}

func (DatabaseSpecEncryptionConfigCodec) Encode(ptr unsafe.Pointer, stream *jsoniter.Stream) {
	obj := (*DatabaseSpecEncryptionConfig)(ptr)
	var objs []DatabaseSpecEncryptionConfig
	if obj != nil {
		objs = []DatabaseSpecEncryptionConfig{*obj}
	}
	...
	jsonit := jsoniter.Config{
		...
		TagKey:                 "tf",
		TypeEncoders:           getEncodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(DatabaseSpecEncryptionConfig{}).Type1())),
	}.Froze()
...
func (DatabaseSpecEncryptionConfigCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.NilValue:
		iter.Skip()
		*(*DatabaseSpecEncryptionConfig)(ptr) = DatabaseSpecEncryptionConfig{}
		return
	case jsoniter.ArrayValue:
		...
		if len(objsByte) > 0 {
			...
			jsonit := jsoniter.Config{
				...
				ValidateJsonRawMessage: true,
				TagKey:                 "tf",
				TypeDecoders:           getDecodersWithout(jsoniter.MustGetKind(reflect2.TypeOf(DatabaseSpecEncryptionConfig{}).Type1())),
			}.Froze()
			jsonit.Unmarshal(objsByte, &objs)

			if len(objs) > 0 {
				*(*DatabaseSpecEncryptionConfig)(ptr) = objs[0]
			} else {
				*(*DatabaseSpecEncryptionConfig)(ptr) = DatabaseSpecEncryptionConfig{}
			}
		} else {
	...
	case jsoniter.ObjectValue:
		...
		if len(objByte) > 0 {
			var obj DatabaseSpecEncryptionConfig
			...
			*(*DatabaseSpecEncryptionConfig)(ptr) = obj
		} else {
			*(*DatabaseSpecEncryptionConfig)(ptr) = DatabaseSpecEncryptionConfig{}
		}
	default:
		iter.ReportError("decode DatabaseSpecEncryptionConfig", "unexpected JSON type")
	}
}
...
func (DatabaseIamBindingSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj DatabaseIamBindingSpecCondition
			...
			*(*DatabaseIamBindingSpecCondition)(ptr) = obj
		} else {
			*(*DatabaseIamBindingSpecCondition)(ptr) = DatabaseIamBindingSpecCondition{}
		}
	default:
...
func (DatabaseIamMemberSpecConditionCodec) Decode(ptr unsafe.Pointer, iter *jsoniter.Iterator) {
	...
	case jsoniter.ObjectValue:
		objByte := iter.SkipAndReturnBytes()
		if len(objByte) > 0 {
			var obj DatabaseIamMemberSpecCondition
			...
			*(*DatabaseIamMemberSpecCondition)(ptr) = obj
		} else {
			*(*DatabaseIamMemberSpecCondition)(ptr) = DatabaseIamMemberSpecCondition{}
		}
	default:
