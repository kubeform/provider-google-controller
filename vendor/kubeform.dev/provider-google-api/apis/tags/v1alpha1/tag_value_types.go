...
type TagValueSpec struct {
	KubeformOutput *TagValueSpecResource `json:"kubeformOutput,omitempty" tf:"-"`

	Resource TagValueSpecResource `json:"resource" tf:"resource"`
...
type TagValueSpecResource struct {
