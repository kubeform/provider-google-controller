...
// EndpointAttachmentsGetter has a method to return a EndpointAttachmentInterface.
...
// endpointAttachments implements EndpointAttachmentInterface
type endpointAttachments struct {
	client rest.Interface
	ns     string
}

// newEndpointAttachments returns a EndpointAttachments
func newEndpointAttachments(c *ApigeeV1alpha1Client, namespace string) *endpointAttachments {
...
func (c *endpointAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointAttachment, err error) {
	result = &v1alpha1.EndpointAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointattachments").
		Name(name).
...
func (c *endpointAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EndpointAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("endpointattachments").
...
func (c *endpointAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *endpointAttachments) Create(ctx context.Context, endpointAttachment *v1alpha1.EndpointAttachment, opts v1.CreateOptions) (result *v1alpha1.EndpointAttachment, err error) {
	result = &v1alpha1.EndpointAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("endpointattachments").
...
func (c *endpointAttachments) Update(ctx context.Context, endpointAttachment *v1alpha1.EndpointAttachment, opts v1.UpdateOptions) (result *v1alpha1.EndpointAttachment, err error) {
	result = &v1alpha1.EndpointAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointattachments").
		Name(endpointAttachment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(endpointAttachment).
		Do(ctx).
		Into(result)
...
func (c *endpointAttachments) UpdateStatus(ctx context.Context, endpointAttachment *v1alpha1.EndpointAttachment, opts v1.UpdateOptions) (result *v1alpha1.EndpointAttachment, err error) {
	result = &v1alpha1.EndpointAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("endpointattachments").
...
func (c *endpointAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *endpointAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *endpointAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointAttachment, err error) {
	result = &v1alpha1.EndpointAttachment{}
