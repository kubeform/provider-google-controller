...
// EnvironmentIamBindingsGetter has a method to return a EnvironmentIamBindingInterface.
...
// environmentIamBindings implements EnvironmentIamBindingInterface
type environmentIamBindings struct {
	client rest.Interface
	ns     string
}

// newEnvironmentIamBindings returns a EnvironmentIamBindings
func newEnvironmentIamBindings(c *ApigeeV1alpha1Client, namespace string) *environmentIamBindings {
	return &environmentIamBindings{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *environmentIamBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EnvironmentIamBinding, err error) {
	result = &v1alpha1.EnvironmentIamBinding{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("environmentiambindings").
		Name(name).
...
func (c *environmentIamBindings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EnvironmentIamBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EnvironmentIamBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("environmentiambindings").
...
func (c *environmentIamBindings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *environmentIamBindings) Create(ctx context.Context, environmentIamBinding *v1alpha1.EnvironmentIamBinding, opts v1.CreateOptions) (result *v1alpha1.EnvironmentIamBinding, err error) {
	result = &v1alpha1.EnvironmentIamBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("environmentiambindings").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(environmentIamBinding).
		Do(ctx).
		Into(result)
	return
}
...
func (c *environmentIamBindings) Update(ctx context.Context, environmentIamBinding *v1alpha1.EnvironmentIamBinding, opts v1.UpdateOptions) (result *v1alpha1.EnvironmentIamBinding, err error) {
	result = &v1alpha1.EnvironmentIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("environmentiambindings").
		Name(environmentIamBinding.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(environmentIamBinding).
		Do(ctx).
		Into(result)
...
func (c *environmentIamBindings) UpdateStatus(ctx context.Context, environmentIamBinding *v1alpha1.EnvironmentIamBinding, opts v1.UpdateOptions) (result *v1alpha1.EnvironmentIamBinding, err error) {
	result = &v1alpha1.EnvironmentIamBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("environmentiambindings").
...
func (c *environmentIamBindings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *environmentIamBindings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *environmentIamBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EnvironmentIamBinding, err error) {
	result = &v1alpha1.EnvironmentIamBinding{}
