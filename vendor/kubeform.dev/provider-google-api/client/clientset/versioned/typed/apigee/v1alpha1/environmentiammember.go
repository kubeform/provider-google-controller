...
// EnvironmentIamMembersGetter has a method to return a EnvironmentIamMemberInterface.
...
// environmentIamMembers implements EnvironmentIamMemberInterface
type environmentIamMembers struct {
	client rest.Interface
	ns     string
}

// newEnvironmentIamMembers returns a EnvironmentIamMembers
func newEnvironmentIamMembers(c *ApigeeV1alpha1Client, namespace string) *environmentIamMembers {
	return &environmentIamMembers{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *environmentIamMembers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EnvironmentIamMember, err error) {
	result = &v1alpha1.EnvironmentIamMember{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("environmentiammembers").
		Name(name).
...
func (c *environmentIamMembers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EnvironmentIamMemberList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.EnvironmentIamMemberList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("environmentiammembers").
...
func (c *environmentIamMembers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *environmentIamMembers) Create(ctx context.Context, environmentIamMember *v1alpha1.EnvironmentIamMember, opts v1.CreateOptions) (result *v1alpha1.EnvironmentIamMember, err error) {
	result = &v1alpha1.EnvironmentIamMember{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("environmentiammembers").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(environmentIamMember).
		Do(ctx).
		Into(result)
	return
}
...
func (c *environmentIamMembers) Update(ctx context.Context, environmentIamMember *v1alpha1.EnvironmentIamMember, opts v1.UpdateOptions) (result *v1alpha1.EnvironmentIamMember, err error) {
	result = &v1alpha1.EnvironmentIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("environmentiammembers").
		Name(environmentIamMember.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(environmentIamMember).
		Do(ctx).
		Into(result)
...
func (c *environmentIamMembers) UpdateStatus(ctx context.Context, environmentIamMember *v1alpha1.EnvironmentIamMember, opts v1.UpdateOptions) (result *v1alpha1.EnvironmentIamMember, err error) {
	result = &v1alpha1.EnvironmentIamMember{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("environmentiammembers").
...
func (c *environmentIamMembers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *environmentIamMembers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *environmentIamMembers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EnvironmentIamMember, err error) {
	result = &v1alpha1.EnvironmentIamMember{}
