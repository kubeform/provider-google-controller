...
// FirewallPolicyAssociationsGetter has a method to return a FirewallPolicyAssociationInterface.
...
// firewallPolicyAssociations implements FirewallPolicyAssociationInterface
type firewallPolicyAssociations struct {
	client rest.Interface
	ns     string
}

// newFirewallPolicyAssociations returns a FirewallPolicyAssociations
func newFirewallPolicyAssociations(c *ComputeV1alpha1Client, namespace string) *firewallPolicyAssociations {
	return &firewallPolicyAssociations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *firewallPolicyAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirewallPolicyAssociation, err error) {
	result = &v1alpha1.FirewallPolicyAssociation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *firewallPolicyAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirewallPolicyAssociationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FirewallPolicyAssociationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firewallpolicyassociations").
...
func (c *firewallPolicyAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *firewallPolicyAssociations) Create(ctx context.Context, firewallPolicyAssociation *v1alpha1.FirewallPolicyAssociation, opts v1.CreateOptions) (result *v1alpha1.FirewallPolicyAssociation, err error) {
	result = &v1alpha1.FirewallPolicyAssociation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("firewallpolicyassociations").
...
func (c *firewallPolicyAssociations) Update(ctx context.Context, firewallPolicyAssociation *v1alpha1.FirewallPolicyAssociation, opts v1.UpdateOptions) (result *v1alpha1.FirewallPolicyAssociation, err error) {
	result = &v1alpha1.FirewallPolicyAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallpolicyassociations").
		Name(firewallPolicyAssociation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(firewallPolicyAssociation).
		Do(ctx).
		Into(result)
...
func (c *firewallPolicyAssociations) UpdateStatus(ctx context.Context, firewallPolicyAssociation *v1alpha1.FirewallPolicyAssociation, opts v1.UpdateOptions) (result *v1alpha1.FirewallPolicyAssociation, err error) {
	result = &v1alpha1.FirewallPolicyAssociation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallpolicyassociations").
...
func (c *firewallPolicyAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *firewallPolicyAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *firewallPolicyAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FirewallPolicyAssociation, err error) {
	result = &v1alpha1.FirewallPolicyAssociation{}
