...
// FirewallPolicyRulesGetter has a method to return a FirewallPolicyRuleInterface.
...
// firewallPolicyRules implements FirewallPolicyRuleInterface
type firewallPolicyRules struct {
	client rest.Interface
	ns     string
}

// newFirewallPolicyRules returns a FirewallPolicyRules
func newFirewallPolicyRules(c *ComputeV1alpha1Client, namespace string) *firewallPolicyRules {
...
func (c *firewallPolicyRules) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirewallPolicyRule, err error) {
	result = &v1alpha1.FirewallPolicyRule{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *firewallPolicyRules) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirewallPolicyRuleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FirewallPolicyRuleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firewallpolicyrules").
...
func (c *firewallPolicyRules) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *firewallPolicyRules) Create(ctx context.Context, firewallPolicyRule *v1alpha1.FirewallPolicyRule, opts v1.CreateOptions) (result *v1alpha1.FirewallPolicyRule, err error) {
	result = &v1alpha1.FirewallPolicyRule{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("firewallpolicyrules").
...
func (c *firewallPolicyRules) Update(ctx context.Context, firewallPolicyRule *v1alpha1.FirewallPolicyRule, opts v1.UpdateOptions) (result *v1alpha1.FirewallPolicyRule, err error) {
	result = &v1alpha1.FirewallPolicyRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallpolicyrules").
		Name(firewallPolicyRule.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(firewallPolicyRule).
		Do(ctx).
		Into(result)
...
func (c *firewallPolicyRules) UpdateStatus(ctx context.Context, firewallPolicyRule *v1alpha1.FirewallPolicyRule, opts v1.UpdateOptions) (result *v1alpha1.FirewallPolicyRule, err error) {
	result = &v1alpha1.FirewallPolicyRule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firewallpolicyrules").
...
func (c *firewallPolicyRules) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *firewallPolicyRules) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *firewallPolicyRules) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FirewallPolicyRule, err error) {
	result = &v1alpha1.FirewallPolicyRule{}
