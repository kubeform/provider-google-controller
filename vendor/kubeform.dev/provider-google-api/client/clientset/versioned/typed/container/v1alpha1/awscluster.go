...
func newAwsClusters(c *ContainerV1alpha1Client, namespace string) *awsClusters {
	return &awsClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *awsClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AwsCluster, err error) {
	result = &v1alpha1.AwsCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *awsClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AwsClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AwsClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("awsclusters").
...
func (c *awsClusters) Create(ctx context.Context, awsCluster *v1alpha1.AwsCluster, opts v1.CreateOptions) (result *v1alpha1.AwsCluster, err error) {
	result = &v1alpha1.AwsCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("awsclusters").
...
func (c *awsClusters) Update(ctx context.Context, awsCluster *v1alpha1.AwsCluster, opts v1.UpdateOptions) (result *v1alpha1.AwsCluster, err error) {
	result = &v1alpha1.AwsCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsclusters").
...
func (c *awsClusters) UpdateStatus(ctx context.Context, awsCluster *v1alpha1.AwsCluster, opts v1.UpdateOptions) (result *v1alpha1.AwsCluster, err error) {
	result = &v1alpha1.AwsCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("awsclusters").
...
func (c *awsClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AwsCluster, err error) {
	result = &v1alpha1.AwsCluster{}
