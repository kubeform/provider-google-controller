...
// CxEntityTypesGetter has a method to return a CxEntityTypeInterface.
...
// cxEntityTypes implements CxEntityTypeInterface
type cxEntityTypes struct {
	client rest.Interface
	ns     string
}

// newCxEntityTypes returns a CxEntityTypes
func newCxEntityTypes(c *DialogflowV1alpha1Client, namespace string) *cxEntityTypes {
	return &cxEntityTypes{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cxEntityTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CxEntityType, err error) {
	result = &v1alpha1.CxEntityType{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cxEntityTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CxEntityTypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CxEntityTypeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxentitytypes").
...
func (c *cxEntityTypes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cxEntityTypes) Create(ctx context.Context, cxEntityType *v1alpha1.CxEntityType, opts v1.CreateOptions) (result *v1alpha1.CxEntityType, err error) {
	result = &v1alpha1.CxEntityType{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cxentitytypes").
...
func (c *cxEntityTypes) Update(ctx context.Context, cxEntityType *v1alpha1.CxEntityType, opts v1.UpdateOptions) (result *v1alpha1.CxEntityType, err error) {
	result = &v1alpha1.CxEntityType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxentitytypes").
		Name(cxEntityType.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cxEntityType).
		Do(ctx).
		Into(result)
...
func (c *cxEntityTypes) UpdateStatus(ctx context.Context, cxEntityType *v1alpha1.CxEntityType, opts v1.UpdateOptions) (result *v1alpha1.CxEntityType, err error) {
	result = &v1alpha1.CxEntityType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxentitytypes").
...
func (c *cxEntityTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cxEntityTypes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cxEntityTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CxEntityType, err error) {
	result = &v1alpha1.CxEntityType{}
