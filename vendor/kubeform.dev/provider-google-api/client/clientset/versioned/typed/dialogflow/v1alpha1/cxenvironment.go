...
// CxEnvironmentsGetter has a method to return a CxEnvironmentInterface.
...
// cxEnvironments implements CxEnvironmentInterface
type cxEnvironments struct {
	client rest.Interface
	ns     string
}

// newCxEnvironments returns a CxEnvironments
func newCxEnvironments(c *DialogflowV1alpha1Client, namespace string) *cxEnvironments {
	return &cxEnvironments{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cxEnvironments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CxEnvironment, err error) {
	result = &v1alpha1.CxEnvironment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cxEnvironments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CxEnvironmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CxEnvironmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxenvironments").
...
func (c *cxEnvironments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cxEnvironments) Create(ctx context.Context, cxEnvironment *v1alpha1.CxEnvironment, opts v1.CreateOptions) (result *v1alpha1.CxEnvironment, err error) {
	result = &v1alpha1.CxEnvironment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cxenvironments").
...
func (c *cxEnvironments) Update(ctx context.Context, cxEnvironment *v1alpha1.CxEnvironment, opts v1.UpdateOptions) (result *v1alpha1.CxEnvironment, err error) {
	result = &v1alpha1.CxEnvironment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxenvironments").
		Name(cxEnvironment.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cxEnvironment).
		Do(ctx).
		Into(result)
...
func (c *cxEnvironments) UpdateStatus(ctx context.Context, cxEnvironment *v1alpha1.CxEnvironment, opts v1.UpdateOptions) (result *v1alpha1.CxEnvironment, err error) {
	result = &v1alpha1.CxEnvironment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxenvironments").
...
func (c *cxEnvironments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cxEnvironments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cxEnvironments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CxEnvironment, err error) {
	result = &v1alpha1.CxEnvironment{}
