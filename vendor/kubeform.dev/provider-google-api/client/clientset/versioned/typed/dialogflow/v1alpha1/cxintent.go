...
// CxIntentsGetter has a method to return a CxIntentInterface.
...
// cxIntents implements CxIntentInterface
type cxIntents struct {
	client rest.Interface
	ns     string
}

// newCxIntents returns a CxIntents
func newCxIntents(c *DialogflowV1alpha1Client, namespace string) *cxIntents {
	return &cxIntents{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cxIntents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CxIntent, err error) {
	result = &v1alpha1.CxIntent{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxintents").
		Name(name).
...
func (c *cxIntents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CxIntentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CxIntentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxintents").
...
func (c *cxIntents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cxIntents) Create(ctx context.Context, cxIntent *v1alpha1.CxIntent, opts v1.CreateOptions) (result *v1alpha1.CxIntent, err error) {
	result = &v1alpha1.CxIntent{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cxintents").
...
func (c *cxIntents) Update(ctx context.Context, cxIntent *v1alpha1.CxIntent, opts v1.UpdateOptions) (result *v1alpha1.CxIntent, err error) {
	result = &v1alpha1.CxIntent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxintents").
...
func (c *cxIntents) UpdateStatus(ctx context.Context, cxIntent *v1alpha1.CxIntent, opts v1.UpdateOptions) (result *v1alpha1.CxIntent, err error) {
	result = &v1alpha1.CxIntent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxintents").
...
func (c *cxIntents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cxIntents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cxIntents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CxIntent, err error) {
	result = &v1alpha1.CxIntent{}
