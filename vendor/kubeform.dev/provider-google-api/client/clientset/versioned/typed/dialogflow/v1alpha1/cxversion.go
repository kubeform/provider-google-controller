...
// CxVersionsGetter has a method to return a CxVersionInterface.
...
// cxVersions implements CxVersionInterface
type cxVersions struct {
	client rest.Interface
	ns     string
}

// newCxVersions returns a CxVersions
func newCxVersions(c *DialogflowV1alpha1Client, namespace string) *cxVersions {
	return &cxVersions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cxVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CxVersion, err error) {
	result = &v1alpha1.CxVersion{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxversions").
		Name(name).
...
func (c *cxVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CxVersionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CxVersionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cxversions").
...
func (c *cxVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cxVersions) Create(ctx context.Context, cxVersion *v1alpha1.CxVersion, opts v1.CreateOptions) (result *v1alpha1.CxVersion, err error) {
	result = &v1alpha1.CxVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cxversions").
...
func (c *cxVersions) Update(ctx context.Context, cxVersion *v1alpha1.CxVersion, opts v1.UpdateOptions) (result *v1alpha1.CxVersion, err error) {
	result = &v1alpha1.CxVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxversions").
...
func (c *cxVersions) UpdateStatus(ctx context.Context, cxVersion *v1alpha1.CxVersion, opts v1.UpdateOptions) (result *v1alpha1.CxVersion, err error) {
	result = &v1alpha1.CxVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cxversions").
...
func (c *cxVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cxVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cxVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CxVersion, err error) {
	result = &v1alpha1.CxVersion{}
