...
// ServicesEdgeCacheKeysetsGetter has a method to return a ServicesEdgeCacheKeysetInterface.
...
// servicesEdgeCacheKeysets implements ServicesEdgeCacheKeysetInterface
type servicesEdgeCacheKeysets struct {
	client rest.Interface
	ns     string
}

// newServicesEdgeCacheKeysets returns a ServicesEdgeCacheKeysets
func newServicesEdgeCacheKeysets(c *NetworkV1alpha1Client, namespace string) *servicesEdgeCacheKeysets {
	return &servicesEdgeCacheKeysets{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *servicesEdgeCacheKeysets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicesEdgeCacheKeyset, err error) {
	result = &v1alpha1.ServicesEdgeCacheKeyset{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *servicesEdgeCacheKeysets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicesEdgeCacheKeysetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServicesEdgeCacheKeysetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicesedgecachekeysets").
...
func (c *servicesEdgeCacheKeysets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicesEdgeCacheKeysets) Create(ctx context.Context, servicesEdgeCacheKeyset *v1alpha1.ServicesEdgeCacheKeyset, opts v1.CreateOptions) (result *v1alpha1.ServicesEdgeCacheKeyset, err error) {
	result = &v1alpha1.ServicesEdgeCacheKeyset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicesedgecachekeysets").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesEdgeCacheKeyset).
		Do(ctx).
		Into(result)
	return
}
...
func (c *servicesEdgeCacheKeysets) Update(ctx context.Context, servicesEdgeCacheKeyset *v1alpha1.ServicesEdgeCacheKeyset, opts v1.UpdateOptions) (result *v1alpha1.ServicesEdgeCacheKeyset, err error) {
	result = &v1alpha1.ServicesEdgeCacheKeyset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesedgecachekeysets").
		Name(servicesEdgeCacheKeyset.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesEdgeCacheKeyset).
		Do(ctx).
		Into(result)
...
func (c *servicesEdgeCacheKeysets) UpdateStatus(ctx context.Context, servicesEdgeCacheKeyset *v1alpha1.ServicesEdgeCacheKeyset, opts v1.UpdateOptions) (result *v1alpha1.ServicesEdgeCacheKeyset, err error) {
	result = &v1alpha1.ServicesEdgeCacheKeyset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesedgecachekeysets").
...
func (c *servicesEdgeCacheKeysets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicesEdgeCacheKeysets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicesEdgeCacheKeysets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicesEdgeCacheKeyset, err error) {
	result = &v1alpha1.ServicesEdgeCacheKeyset{}
