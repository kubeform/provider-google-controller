...
// ServicesEdgeCacheServicesGetter has a method to return a ServicesEdgeCacheServiceInterface.
...
// servicesEdgeCacheServices implements ServicesEdgeCacheServiceInterface
type servicesEdgeCacheServices struct {
	client rest.Interface
	ns     string
}

// newServicesEdgeCacheServices returns a ServicesEdgeCacheServices
func newServicesEdgeCacheServices(c *NetworkV1alpha1Client, namespace string) *servicesEdgeCacheServices {
	return &servicesEdgeCacheServices{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *servicesEdgeCacheServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	result = &v1alpha1.ServicesEdgeCacheService{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *servicesEdgeCacheServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ServicesEdgeCacheServiceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ServicesEdgeCacheServiceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("servicesedgecacheservices").
...
func (c *servicesEdgeCacheServices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *servicesEdgeCacheServices) Create(ctx context.Context, servicesEdgeCacheService *v1alpha1.ServicesEdgeCacheService, opts v1.CreateOptions) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	result = &v1alpha1.ServicesEdgeCacheService{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("servicesedgecacheservices").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesEdgeCacheService).
		Do(ctx).
		Into(result)
	return
}
...
func (c *servicesEdgeCacheServices) Update(ctx context.Context, servicesEdgeCacheService *v1alpha1.ServicesEdgeCacheService, opts v1.UpdateOptions) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	result = &v1alpha1.ServicesEdgeCacheService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesedgecacheservices").
		Name(servicesEdgeCacheService.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(servicesEdgeCacheService).
		Do(ctx).
		Into(result)
...
func (c *servicesEdgeCacheServices) UpdateStatus(ctx context.Context, servicesEdgeCacheService *v1alpha1.ServicesEdgeCacheService, opts v1.UpdateOptions) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	result = &v1alpha1.ServicesEdgeCacheService{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("servicesedgecacheservices").
...
func (c *servicesEdgeCacheServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *servicesEdgeCacheServices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *servicesEdgeCacheServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ServicesEdgeCacheService, err error) {
	result = &v1alpha1.ServicesEdgeCacheService{}
