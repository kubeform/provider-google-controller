...
type PrivatecaV1alpha1Interface interface {
	RESTClient() rest.Interface
	CaPoolsGetter
	CaPoolIamBindingsGetter
	CaPoolIamMembersGetter
	CaPoolIamPoliciesGetter
	CertificatesGetter
	CertificateAuthoritiesGetter
	CertificateTemplatesGetter
}
...
func (c *PrivatecaV1alpha1Client) CertificateTemplates(namespace string) CertificateTemplateInterface {
	return newCertificateTemplates(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*PrivatecaV1alpha1Client, error) {
	...
	return &PrivatecaV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new PrivatecaV1alpha1Client for the given config and
...
func New(c rest.Interface) *PrivatecaV1alpha1Client {
	return &PrivatecaV1alpha1Client{c}
}
