...
// LiteReservationsGetter has a method to return a LiteReservationInterface.
...
// liteReservations implements LiteReservationInterface
type liteReservations struct {
	client rest.Interface
	ns     string
}

// newLiteReservations returns a LiteReservations
func newLiteReservations(c *PubsubV1alpha1Client, namespace string) *liteReservations {
	return &liteReservations{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *liteReservations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.LiteReservation, err error) {
	result = &v1alpha1.LiteReservation{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *liteReservations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.LiteReservationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.LiteReservationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("litereservations").
...
func (c *liteReservations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *liteReservations) Create(ctx context.Context, liteReservation *v1alpha1.LiteReservation, opts v1.CreateOptions) (result *v1alpha1.LiteReservation, err error) {
	result = &v1alpha1.LiteReservation{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("litereservations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(liteReservation).
		Do(ctx).
		Into(result)
	return
}
...
func (c *liteReservations) Update(ctx context.Context, liteReservation *v1alpha1.LiteReservation, opts v1.UpdateOptions) (result *v1alpha1.LiteReservation, err error) {
	result = &v1alpha1.LiteReservation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("litereservations").
		Name(liteReservation.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(liteReservation).
		Do(ctx).
		Into(result)
...
func (c *liteReservations) UpdateStatus(ctx context.Context, liteReservation *v1alpha1.LiteReservation, opts v1.UpdateOptions) (result *v1alpha1.LiteReservation, err error) {
	result = &v1alpha1.LiteReservation{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("litereservations").
...
func (c *liteReservations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *liteReservations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *liteReservations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.LiteReservation, err error) {
	result = &v1alpha1.LiteReservation{}
