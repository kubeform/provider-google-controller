...
// NetworkingPeeredDNSDomainsGetter has a method to return a NetworkingPeeredDNSDomainInterface.
...
// networkingPeeredDNSDomains implements NetworkingPeeredDNSDomainInterface
type networkingPeeredDNSDomains struct {
	client rest.Interface
	ns     string
}

// newNetworkingPeeredDNSDomains returns a NetworkingPeeredDNSDomains
func newNetworkingPeeredDNSDomains(c *ServiceV1alpha1Client, namespace string) *networkingPeeredDNSDomains {
	return &networkingPeeredDNSDomains{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *networkingPeeredDNSDomains) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NetworkingPeeredDNSDomain, err error) {
	result = &v1alpha1.NetworkingPeeredDNSDomain{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkingPeeredDNSDomains) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NetworkingPeeredDNSDomainList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.NetworkingPeeredDNSDomainList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkingpeereddnsdomains").
...
func (c *networkingPeeredDNSDomains) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkingPeeredDNSDomains) Create(ctx context.Context, networkingPeeredDNSDomain *v1alpha1.NetworkingPeeredDNSDomain, opts v1.CreateOptions) (result *v1alpha1.NetworkingPeeredDNSDomain, err error) {
	result = &v1alpha1.NetworkingPeeredDNSDomain{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkingpeereddnsdomains").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkingPeeredDNSDomain).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkingPeeredDNSDomains) Update(ctx context.Context, networkingPeeredDNSDomain *v1alpha1.NetworkingPeeredDNSDomain, opts v1.UpdateOptions) (result *v1alpha1.NetworkingPeeredDNSDomain, err error) {
	result = &v1alpha1.NetworkingPeeredDNSDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkingpeereddnsdomains").
		Name(networkingPeeredDNSDomain.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkingPeeredDNSDomain).
		Do(ctx).
		Into(result)
...
func (c *networkingPeeredDNSDomains) UpdateStatus(ctx context.Context, networkingPeeredDNSDomain *v1alpha1.NetworkingPeeredDNSDomain, opts v1.UpdateOptions) (result *v1alpha1.NetworkingPeeredDNSDomain, err error) {
	result = &v1alpha1.NetworkingPeeredDNSDomain{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkingpeereddnsdomains").
...
func (c *networkingPeeredDNSDomains) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkingPeeredDNSDomains) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkingPeeredDNSDomains) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.NetworkingPeeredDNSDomain, err error) {
	result = &v1alpha1.NetworkingPeeredDNSDomain{}
